...
void CLevelMgr::init()
{
	...
	pLightObj->Transform()->SetRelativePos(Vec3(-300.f, 0.f, 0.f));

	pLightObj->Light2D()->SetLightType(LIGHT_TYPE::POINT);
	pLightObj->Light2D()->SetDiffuse(Vec3(0.8f, 0.2f, 0.2f));
	pLightObj->Light2D()->SetAmbient(Vec3(0.f, 0.f, 0.f));
	pLightObj->Light2D()->SetRange(400.f);
	...
	pLightObj->Light2D()->SetLightType(LIGHT_TYPE::POINT);
	pLightObj->Light2D()->SetDiffuse(Vec3(0.2f, 0.8f, 0.2f));
	pLightObj->Light2D()->SetAmbient(Vec3(0.f, 0.f, 0.f));
	pLightObj->Light2D()->SetRange(400.f);
